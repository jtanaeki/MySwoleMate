...
namespace MySwoleMate.BLL
{
    public class TraineeBLL
    {
        ...
        private string HeightDisplay(int height)
        {
            ...
            heightDisplay = height/12 + " ft. " + height%12 + " in.";

            return heightDisplay;
        }
        private string PhoneDisplay(string cellNbr)
        {
            //store the displayed cell number
            string phoneDisplay = "";
            phoneDisplay = cellNbr;
            //inserts the dashes
        ...
        //Assigns the Trainee accepting a TraineeViewModel
        public int AssignTrainee(TraineeViewModel assign)
        {
            return data.AssignTrainee(assign);
        }
    }
}
